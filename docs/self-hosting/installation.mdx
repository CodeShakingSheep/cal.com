...
<Info>
To ensure optimal performance and compatibility, we highly recommend using Node.js version 20 (min. version 20.9) for your development environment. This version provides the best balance of stability, features, and security for this project. Please make sure to update your Node.js installation if necessary.
</Info>
